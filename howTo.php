...
<main>
    <?php
        $q = $mysqli -> query("SELECT * FROM posts WHERE category = 'howTo'");
        while($r = $q -> fetch_assoc()){
            echo '
                <div class="posts"><h1>'.$r["title"].'</h1>
                '.$r["content"].'
                 <a href="deletePost.php?id='.$r['id'].'&return=howTo">Delete</a></div>
            ';
        }
    ?>
    <br>
    <a href="addPost.php?category=howTo">Add new recipe</a>
</main>
<footer>
