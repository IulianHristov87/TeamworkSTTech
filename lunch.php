...
<main>
    <?php
        $q = $mysqli -> query("SELECT * FROM posts WHERE category = 'lunch'");
        while($r = $q -> fetch_assoc()){
            echo '
                <div class="posts"><h1>'.$r["title"].'</h1>
                '.$r["content"].'
                 <a href="deletePost.php?id='.$r['id'].'&return=lunch">Delete</a></div>
            ';
        }
    ?>
    <br>
    <a href="addPost.php?category=lunch">Add new recipe</a>
</main>
<footer>
